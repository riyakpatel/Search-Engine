...
public final class In {
	...
	/***
	 * begin: section (2 of 2) of code duplicated from In to StdIn, with all methods
	 * changed from "public" to "public static"
	 ***/

	/**
	 * Is the input empty (except possibly for whitespace)? Use this to know whether
	 * the next call to {@link #readString()}, {@link #readDouble()}, etc will
	 * succeed.
	 */
	...
	/**
	 * Is the input empty (including whitespace)? Use this to know whether the next
	 * call to {@link #readChar()} will succeed.
	 * <p>
	...
	/**
	 * Read and return the next boolean, allowing case-insensitive "true" or "1" for
	...
	/**
	 * Reads all remaining lines from input stream and returns them as an array of
	 * strings.
	 * 
